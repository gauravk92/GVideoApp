...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    [Parse setApplicationId:@"FZ7JpVl57WUjip9m3i4RosNQQQLxNS5GkqwmXRaM"
                  clientKey:@"OhBAef28W4Q224Q1ydfEGqL5Vbjkq7BBPwCwiWIu"];
...
- (void)presentLoginViewControllerAnimated:(BOOL)animated {
    // [UIColor colorWithRed:0.175 green:0.277 blue:0.504 alpha:1.000]
    // [UIColor colorWithRed:0.173 green:0.198 blue:0.502 alpha:1.000]
    UIImage *buttonState = [UIColor imageWithColor:[UIColor colorWithRed:0.173 green:0.198 blue:0.502 alpha:1.000]];
    UIImage *buttonHState = [UIColor imageWithColor:[UIColor colorWithRed:0.175 green:0.277 blue:0.504 alpha:1.000]];
    GVWelcomeSignupViewController *loginViewController = [[GVWelcomeSignupViewController alloc] init];
    //[loginViewController setDelegate:self];
    //loginViewController.fields = PFLogInFieldsTwitter;
    //loginViewController.facebookPermissions = @[ @"user_about_me" ];
    //[loginViewController.logInView.facebookButton setBackgroundImage:buttonState forState:UIControlStateNormal];
    //[loginViewController.logInView.facebookButton setBackgroundImage:buttonHState forState:UIControlStateHighlighted];
    //loginViewController.logInView.facebookButton.showsTouchWhenHighlighted = NO;
    //[loginViewController.logInView.facebookButton setBackgroundColor:[UIColor colorWithRed:0.175 green:0.277 blue:0.504 alpha:1.000]];
    //loginViewController.logInView.facebookButton.layer.cornerRadius = 1.0;
