...
@property (nonatomic, strong) GfitMainMenuNavigationController *mainMenuNavigation;
@property (nonatomic, strong) UIViewController *contentNavigation;
...
//    contentNavigation.contentNavigationDelegate = self;
    ...
    self.contentNavigation = [[BlueViewController alloc] initWithNibName:nil bundle:nil];
    //self.fakeRootController = fakeRootController;

    [self setViewControllers:@[mainMenuNavigation, self.contentNavigation] animated:NO];
}
...
- (void)pushToViewController:(UIViewController *)viewController {
    ...
    [blockOperation addExecutionBlock:^{
        dispatch_async(dispatch_get_main_queue(), ^{
            ...
            Class currentClass = self.contentNavigation.class;
            ...
            if (strcmp(n1, n2) == 0) {
                ...
                fakeRootController.title = self.mainMenuNavigation.title;
...
//        }
		...
		if (self.presentingContentNavigation) {
			...
			fromNavigationItem = [[UINavigationItem alloc] initWithTitle:@"hey"];
			toNavigationItem = [[UINavigationItem alloc] initWithTitle:@"hi"];
			...
			fromNavigationItem = [[UINavigationItem alloc] initWithTitle:@"hiiii"];
			toNavigationItem = [[UINavigationItem alloc] initWithTitle:@"sSup"];
